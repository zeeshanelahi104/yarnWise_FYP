    ...
    <>
      <div className="dashboard-items-wrapper flex justify-center items-center container">
        <div className="items-wrapper flex justify-between flex-wrap gap-5 py-5 w-full">
          <div className="single-item bg-red-500 lg:w-[30%] md:w-[45%] sm:w-full">
          ...
          <div className="single-item bg-[#00A65A] lg:w-[30%] md:w-[45%] sm:w-full">
            <div className="flex justify-between p-5">
              <div className="count flex flex-col justify-between gap-4 text-white text-[20px]">
          ...
          <div className="single-item bg-blue-400 lg:w-[30%] md:w-[45%] sm:w-full">
            <div className="flex justify-between p-5">
              <div className="count flex flex-col justify-between gap-4 text-white text-[20px]">
          ...
          <div className="single-item bg-yellow-400 lg:w-[30%] md:w-[45%] sm:w-full">
            <div className="flex justify-between p-5">
              <div className="count flex flex-col justify-between gap-4 text-white text-[20px]">
          ...
          <div className="single-item bg-orange-500 lg:w-[30%] md:w-[45%] sm:w-full">
            <div className="flex justify-between p-5">
              <div className="count flex flex-col justify-between gap-4 text-white text-[20px]">
          ...
          <div className="single-item bg-[#9846cf] lg:w-[30%] md:w-[45%] sm:w-full">
            <div className="flex justify-between p-5">
              <div className="count flex flex-col justify-between gap-4 text-white text-[20px]">

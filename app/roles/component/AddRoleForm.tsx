...
export default function AddRoleForm() {
  ...
  //   try {
  //     const response = await axios.post("http://localhost:3000/api/refreshToken");
        ...
        await Promise.all(
          users.data.users.map(async (user: any) => {
            try {
              ...
              await axios.post(`http://localhost:3000/api/updateUserPermissions`, {
                userId: user._id,
